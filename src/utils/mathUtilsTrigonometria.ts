...
import {
  ...
  export function generateGraphExplanationSteps(
      ...
      calculationSteps.push(`Step ${stepCount}: Identify the function type and its general form`);
      ...
      stepCount++;
      calculationSteps.push(`Step ${stepCount}: Analyze the domain and range`);
      ...
      stepCount++;
      calculationSteps.push(`Step ${stepCount}: Analyze the function properties`);
      ...
      stepCount++;
      calculationSteps.push(`Step ${stepCount}: Calculate notable values`);
      ...
      // Passo 5: Conclusão
      stepCount++;
      calculationSteps.push(`Step ${stepCount}: Conclusion`);
