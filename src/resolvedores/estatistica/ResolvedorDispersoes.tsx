    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Medidas de Dispersão</h2>
            </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <label className="inline-flex items-center">
                            ...
                            />
                            <span className="ml-2 text-gray-700 dark:text-gray-300">Desvio Médio</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input
                                type="radio"
                                ...
                                className="form-radio text-indigo-600 dark:text-indigo-400"
                            />
                            <span className="ml-2 text-gray-700 dark:text-gray-300">Variância</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input
                                type="radio"
                                ...
                                className="form-radio text-indigo-600 dark:text-indigo-400"
                            />
                            <span className="ml-2 text-gray-700 dark:text-gray-300">Desvio Padrão</span>
                        </label>
                    </div>
                </div>
                        ...
                        <div className="mt-8 bg-white dark:bg-gray-800 shadow-md rounded-lg p-5">
                            ...
                            >
                                <div className="flex flex-col md:flex-row gap-4 mb-4">
                                    ...
                                    <div className="flex-1">
                                        <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2 border-b border-gray-200 dark:border-gray-700 pb-1">Aplicações e Comparações</h5>
                                        <div className="p-3 bg-white dark:bg-gray-700 rounded-md border border-gray-100 dark:border-gray-600 shadow-sm">
                                            ...
                                            <div className="space-y-2">
                                                <div className="p-2 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                                                    <span className="font-medium text-blue-700 dark:text-blue-300">Desvio Médio</span>
                                                ...
                                                <div className="p-2 bg-purple-50 dark:bg-purple-900/20 rounded-md">
                                                    <span className="font-medium text-purple-700 dark:text-purple-300">Variância</span>
                                                    <ul className="text-xs list-disc pl-4 mt-1 text-gray-700 dark:text-gray-300">
                                                ...
                                                <div className="p-2 bg-green-50 dark:bg-green-900/20 rounded-md">
                                                    <span className="font-medium text-green-700 dark:text-green-300">Desvio Padrão</span>
                                                    <ul className="text-xs list-disc pl-4 mt-1 text-gray-700 dark:text-gray-300">
                                        ...
                                        <div className="p-3 mt-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-md border-l-4 border-yellow-400 dark:border-yellow-600">
                                            <h6 className="font-medium text-yellow-800 dark:text-yellow-300 mb-1">Interpretação Comparativa</h6>
                                ...
                                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="bg-white dark:bg-gray-700 p-3 rounded-md border border-gray-100 dark:border-gray-600 shadow-sm">
                                        <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Relação com Outras Medidas</h5>
                                        <div className="space-y-2">
                                            <div className="p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-md">
                                                <h6 className="font-medium text-indigo-700 dark:text-indigo-300 mb-1">Coeficiente de Variação (CV)</h6>
                                            ...
                                            <div className="p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-md">
                                                <h6 className="font-medium text-indigo-700 dark:text-indigo-300 mb-1">Variância Populacional e Amostral</h6>
                                                <p className="text-sm text-gray-700 dark:text-gray-300">
