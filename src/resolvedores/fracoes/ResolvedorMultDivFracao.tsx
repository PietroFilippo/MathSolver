  ...
  return (
    <div className="max-w-4xl mx-auto">
        <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Multiplicação e Divisão de Frações </h2>
        </div>
            ...
            <div className="mb-6">
                ...
                <div className="flex space-x-4">
                    <label className="inline-flex items-center">
                        ...
                        />
                        <span className="ml-2 text-gray-700 dark:text-gray-300">Multiplicação (*)</span>
                    </label>
                    <label className="inline-flex items-center">
                        <input
                            type="radio"
                            ...
                            className="form-radio h-4 w-4 text-indigo-600 dark:text-indigo-400"
                        />
                        <span className="ml-2 text-gray-700 dark:text-gray-300">Divisão (/)</span>
                    </label>
                </div>
            </div>
              ...
              >
                <div className="flex flex-col md:flex-row gap-4 mb-4">
                  <div className="flex-1">
                    <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2 border-b border-gray-200 dark:border-gray-700 pb-1">Multiplicação e Divisão de Frações</h5>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white dark:bg-gray-700 p-3 rounded-md border border-gray-100 dark:border-gray-600 shadow-sm space-y-4">
                      <div>
                        <h6 className="text-indigo-700 dark:text-indigo-300 font-medium mb-2">Para Multiplicação</h6>
                        <ol className="text-sm space-y-2 list-decimal pl-5 text-gray-700 dark:text-gray-300">
                          <li>
                            <span className="font-medium text-indigo-700 dark:text-indigo-300">Multiplique os numeradores</span>
                            <p className="text-xs mt-1">
                              O numerador do resultado é o produto dos numeradores das frações originais.
                            </p>
                          </li>
                          <li>
                            <span className="font-medium text-indigo-700 dark:text-indigo-300">Multiplique os denominadores</span>
                            <p className="text-xs mt-1">
                              O denominador do resultado é o produto dos denominadores das frações originais.
                            </p>
                          </li>
                          <li>
                            <span className="font-medium text-indigo-700 dark:text-indigo-300">Simplifique a fração resultante</span>
                            <p className="text-xs mt-1">
                      ...
                      <div className="pt-3 border-t border-gray-100 dark:border-gray-600">
                        <h6 className="text-indigo-700 dark:text-indigo-300 font-medium mb-2">Para Divisão</h6>
                        <ol className="text-sm space-y-2 list-decimal pl-5 text-gray-700 dark:text-gray-300">
                          <li>
                            <span className="font-medium text-indigo-700 dark:text-indigo-300">Inverta a segunda fração (o divisor)</span>
                            <p className="text-xs mt-1">
                              Troque o numerador e o denominador da segunda fração.
                            </p>
                          </li>
                          <li>
                            <span className="font-medium text-indigo-700 dark:text-indigo-300">Transforme a divisão em multiplicação</span>
                            <p className="text-xs mt-1">
                              Multiplique a primeira fração pela segunda fração invertida.
                            </p>
                          </li>
                          <li>
                            <span className="font-medium text-indigo-700 dark:text-indigo-300">Siga os passos da multiplicação</span>
                            <p className="text-xs mt-1">
                ...
                <div className="mt-4 bg-indigo-50 dark:bg-indigo-900/20 p-3 rounded-md">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    <div className="bg-white dark:bg-gray-700 p-2 rounded-md">
                      <p className="text-xs font-medium mb-1 text-indigo-700 dark:text-indigo-300">Multiplicação de Frações como Área</p>
                    ...
                    <div className="bg-white dark:bg-gray-700 p-2 rounded-md">
                      <p className="text-xs font-medium mb-1 text-indigo-700 dark:text-indigo-300">Divisão como Comparação de Tamanhos</p>
                      <div className="flex flex-col items-center">
                        <div className="w-full h-24 flex flex-col items-center">
                          <div className="w-full flex justify-center mb-1">
                    ...
                    <div className="space-y-3">
                      <div className="p-2 bg-indigo-50 dark:bg-indigo-900/20 rounded-md">
                        ...
                        <div className="text-xs text-gray-700 dark:text-gray-300 space-y-1.5">
                          <p className="text-gray-500 dark:text-gray-400">Simplificando antes de multiplicar:</p>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-md border border-blue-100 dark:border-blue-800 shadow-sm">
                      ...
                      <div className="space-y-3 text-sm">
                        <div className="bg-white dark:bg-gray-700 p-2 rounded-md">
                          <p className="font-medium text-gray-700 dark:text-gray-300">Propriedade Comutativa da Multiplicação</p>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                            a/b × c/d = c/d × a/b
                          </p>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                        ...
                        <div className="bg-white dark:bg-gray-700 p-2 rounded-md">
                          <p className="font-medium text-gray-700 dark:text-gray-300">Propriedade Associativa da Multiplicação</p>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                        ...
                        <div className="bg-white dark:bg-gray-700 p-2 rounded-md">
                          <p className="font-medium text-gray-700 dark:text-gray-300">Elemento Neutro da Multiplicação</p>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                            a/b × 1 = a/b
                          </p>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                        ...
                        <div className="bg-white dark:bg-gray-700 p-2 rounded-md">
                          <p className="font-medium text-gray-700 dark:text-gray-300">Recíproco ou Inverso Multiplicativo</p>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                            a/b × b/a = 1
                          </p>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                    ...
                    <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-md border border-green-100 dark:border-green-800">
                      <h5 className="font-medium text-green-800 dark:text-green-300 mb-2">Aplicações no Mundo Real</h5>
                      <ul className="text-sm space-y-1 list-disc pl-4 text-gray-700 dark:text-gray-300">
                    ...
                    <div className="bg-white dark:bg-gray-700 p-3 rounded-md border border-gray-100 dark:border-gray-600 shadow-sm">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div className="bg-purple-50 dark:bg-purple-900/20 p-2 rounded-md">
                          <p className="font-medium text-purple-700 dark:text-purple-300 mb-1">Multiplicação por Zero</p>
                        ...
                        <div className="bg-amber-50 dark:bg-amber-900/20 p-2 rounded-md">
                          <p className="font-medium text-amber-700 dark:text-amber-300 mb-1">Divisão por Zero</p>
                          <p className="text-xs text-gray-700 dark:text-gray-300">
