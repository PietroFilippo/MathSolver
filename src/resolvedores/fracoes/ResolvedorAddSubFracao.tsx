...
const ResolvedorAddSubFracao: React.FC = () => {
    ...
    // Detalhes do MMC
    const MMCDetails = () => {
        if (!state.mmcSteps.den1 || !state.mmcSteps.den2) return null;
                    ...
                    {state.showExplanation && (
                        <div className="mt-8 bg-white shadow-md rounded-lg p-5">
                            ...
                            {state.mmcSteps.den1 !== 0 && (
                                <div className="mb-4">
                                    <button
                                        onClick={() => dispatch({ type: 'TOGGLE_MMC_DETAILS' })}
                                        className="mb-3 flex items-center text-indigo-600 hover:text-indigo-800 text-sm font-medium"
                                    >
                                        <HiInformationCircle className="h-5 w-5 mr-1" />
                                        {state.showMMCDetails ? "Ocultar detalhes do cálculo do MMC" : "Ver detalhes do cálculo do MMC"}
                                    </button>
                                    
                                    {state.showMMCDetails && <MMCDetails />}
                                </div>
                            )}
                                ...
                                <div className="mt-3 bg-indigo-50 p-3 rounded-md">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 mt-2">
                                        <div className="bg-white p-2 rounded-md">
                                            <p className="text-xs font-medium mb-1 text-indigo-700">Adição de frações com mesmo denominador</p>
                                            <div className="flex items-center justify-center space-x-2 text-xs text-gray-700">
                                                <div className="flex flex-col items-center">
                                                    <div className="w-16 h-8 border border-gray-400 rounded-sm flex">
                                                        <div className="bg-blue-200 w-8 h-full"></div>
                                                    </div>
                                                ...
                                                <div className="flex flex-col items-center">
                                                    <div className="w-16 h-8 border border-gray-400 rounded-sm flex">
                                                        <div className="bg-green-200 w-4 h-full"></div>
                                                    </div>
                                        ...
                                        <div className="bg-white p-2 rounded-md">
                                            <p className="text-xs font-medium mb-1 text-indigo-700">Encontrando o denominador comum</p>
                                            <div className="space-y-1 text-xs text-gray-700">
                                                <div className="flex items-center">
                                                    <div className="w-12 h-6 border border-gray-400 rounded-sm grid grid-cols-3">
                                                ...
                                                <div className="flex items-center">
                                                    <div className="w-12 h-6 border border-gray-400 rounded-sm grid grid-cols-4">
                                                ...
                                                <div className="flex items-center">
                                                    <div className="w-12 h-6 border border-gray-400 rounded-sm grid grid-cols-12">
                                                        <div className="bg-blue-200"></div>
                                                        <div className="bg-blue-200"></div>
                                                        <div className="bg-blue-200"></div>
                                                        <div className="bg-blue-200"></div>
